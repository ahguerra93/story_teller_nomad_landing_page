  ...
  void initState() {
    ...
    _controller =
        VideoPlayerController.networkUrl(
            Uri.parse('https://res.cloudinary.com/${getIt.get<RepoConfig>().cloudName}/video/upload/${widget.id}'),
          )
          ..initialize()
              .then((_) async {
        ...
        child: _controller.value.isInitialized
            ...
            : Container(
                child: _controller.value.hasError
                    ...
                    : widget.placeholder ?? Center(child: CustomCircularProgressIndicator()),
              ),
      ),
    );
  }
